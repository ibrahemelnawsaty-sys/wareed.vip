...
@php
    ...
    $deadline = $issued->copy()->addHours($slaHours);
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .party-row span:first-child { color: var(--faint); flex: 0 0 21mm; }
...
<article class="sheet">
    ...
    <section class="parties">
        <div class="party to">
            ...
            <div class="party-body">
                <div class="party-name">{{ $client['name'] ?? $sr->name }}</div>
                <div class="party-row"><span>رقم الجوال</span><b class="ltr">{{ $sr->phone && $sr->phone !== '—' ? $sr->phone : '—' }}</b></div>
                <div class="party-row"><span>البريد الإلكتروني</span><b class="ltr">{{ $sr->email ?: '—' }}</b></div>
                <div class="party-row"><span>اسم المتجر</span><b>{{ $sr->company ?: '—' }}</b></div>
            </div>
        </div>
    ...
    <section class="pledge">
        ...
        <p class="pledge-tx">
            ...
            خلال <b>{{ $slaHours }} ساعة</b> من تاريخ الاستلام.
        </p>
    </section>
