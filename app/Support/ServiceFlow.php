...
class ServiceFlow
{
    ...
    private const PROFILES = [
        'ecommerce' => [
            ...
            'countdown_label' => 'الوقت المتبقي لتسليم المتجر',
            // عنوان صفحة المتابعة لكل مرحلة، يليه اسم العميل: «تم استلام طلبك يا هاجر»
            'headlines' => [
            ...
            'requirements' => [
                ...
                'short' => 'ملفات الهوية البصرية وبيانات المنتجات لتنطلق مرحلة التنفيذ',
                'cta' => 'ارفع متطلبات مشروعك',
        ...
        'tech_solution' => [
            ...
            'contract_title' => 'عقد تنفيذ مشروع',
            'contract_en' => 'SERVICE AGREEMENT',
            'countdown_label' => 'الوقت المتبقي لتسليم المشروع',
            'headlines' => [
                'awaiting_meeting' => 'تم استلام طلبك يا',
                'meeting_scheduled' => 'اجتماعنا محدّد يا',
                'quote_due' => 'نجهّز عرض سعرك الآن يا',
                'awaiting_approval' => 'عرض سعر مشروعك جاهز يا',
                'awaiting_contract' => 'اعتُمد عرض مشروعك يا',
                'awaiting_requirements' => 'اعتُمد عقد مشروعك يا',
                'in_progress' => 'بدأ تنفيذ مشروعك يا',
                'delivered' => 'تم تسليم مشروعك يا',
            ],
            'requirements' => [
                'title' => 'متطلبات المشروع',
                'short' => 'وثائق النظام الحالي وصلاحيات الوصول لتنطلق مرحلة التنفيذ',
                'cta' => 'ارفع متطلبات مشروعك',
        ...
        'training' => [
            ...
            'countdown_label' => 'الوقت المتبقي لختام البرنامج',
            'headlines' => [
                'awaiting_meeting' => 'تم استلام طلبك يا',
                'meeting_scheduled' => 'مكالمتنا محدّدة يا',
                'quote_due' => 'نجهّز عرض سعرك الآن يا',
                'awaiting_approval' => 'عرض سعر برنامجك جاهز يا',
                'awaiting_contract' => 'اعتُمد عرض برنامجك يا',
                'awaiting_requirements' => 'اعتُمد عقد برنامجك يا',
                'in_progress' => 'انطلق برنامجك التدريبي يا',
                'delivered' => 'اكتمل برنامجك التدريبي يا',
            ],
            'requirements' => [
                'title' => 'بيانات المتدربين والجدولة',
                'short' => 'قائمة المتدربين وموعد الانطلاق ليبدأ البرنامج',
                'cta' => 'ارفع بيانات المتدربين وموعد الانطلاق',
